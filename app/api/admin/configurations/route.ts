...
import prisma from '@/lib/prisma';           // keep this for prisma client
import { requireAuth, requireCompanyScope } from '@/lib/rbac'; // your RBAC helpers
import { UserRole } from '@prisma/client';  // Prisma enum for user roles
